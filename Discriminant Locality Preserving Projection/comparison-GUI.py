...
class Window(QMainWindow):
    ...
    def execute_algorithm(self):
        try:
            ...
            np.savetxt(f"{method}{d}{lpp_method}.csv", np.array([range(1, p+1), accuracies, std_deviations]).T, delimiter=",", fmt="%.4f", header="d,accuracy,std_deviation", comments="")
                # 计算标准差
